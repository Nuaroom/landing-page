              ...
              {articles.map((article, index) => (
                ...
                >
                  <article className="h-full flex flex-col">
                    {/* Image placeholder */}
                    <div className="aspect-[16/9] rounded-lg overflow-hidden mb-5 bg-neutral-100 dark:bg-neutral-800">
                      <div
