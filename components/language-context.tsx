...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "home.compare.without.title1": { en: "1 year stuck rebuilding legacy UX.", ko: "레거시 UX를 1년째 재작업 중." },
  "home.compare.without.title2": { en: "Without dedicated UX Expert.", ko: "전담 UX 전문가 없이." },
  ...
  "home.compare.with.title2": { en: "Then build what\u2019s next with clarity.", ko: "그다음은 명확하게 다음을 빌드." },
  "home.compare.without.noDirection": { en: "with no UX direction.", ko: "UX 방향 없이." },
  "home.compare.without.uxBreaks": { en: "UX Breaks", ko: "UX 붕괴" },
  "home.compare.without.uxBreaksCaption": {
    en: "1+ quarter lost to rework.",
    ko: "재작업으로 분기 1회 이상을 잃습니다.",
  },
